    ...
    template: `
        <div class="col-9 col-xs-8 col-sm-7 col-md-6 col-lg-5 col-xl-4 mx-auto mt-5">
            ...
            <form  @submit.prevent="salvar">
                ...
                <input-text label="Nome: " id="nome" v-model="setor.nome" :valor="setor.nome" 
                      ...
                      if(sucesso){
                          setorService.salvar(componente.setor)
                              .then(function (response) { 
                                  ...
                                  componente.$root.mostrarMensagem("Setor Alterado com sucesso", "success");
